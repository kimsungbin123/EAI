...
<div id="mySidenav" class="sidenav">
  ...
  <a href="pelaporan_transaksi.php">Pelaporan Transaksi</a>
    ...
    <!-- form -->
    <form action="index_gr.php" method="post">
    <div class="container">
    <div class="card" >
    <div class="card-body" style="margin-left: 200px; margin-right: 200px; margin-top:50px;">
            <form action="function_GR.php" method="POST" >
                <h2 align="center">LAPORAN GOOD RECEIPT</h2><hr>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama"id="nama" class="form-control" autofocus autocomplete="off" required>
                </div>
                <div class="form-group">
   ...
   <?php
    if(isset($_POST['submit'])) {
      ...
      $insert = mysqli_query($conn, "INSERT INTO laporangood_receipt (id, tanggal, nama, ammount) VALUES ('$id', '$tanggal', '$nama', '$ammount')");
}
  ?>
