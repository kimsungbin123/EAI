...
<div id="main">
    ...
    <div class="card-body" style="margin-left: 200px; margin-right: 200px; margin-top:50px;">
            <form action="function_reimbursment.php" method="POST" >
                <h2 align="center">LAPORAN REIMBURSMENT</h2><hr>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_pegawai" id="nama_pegawai" class="form-control" autofocus autocomplete="off" required>
                </div>
                <div class="form-group">
                    <label for="id_pegawai">Id Pegawai</label>
                    <input type="text" name="id_pegawai" id="id_pegawai" class="form-control" autofocus autocomplete="off" required>
                </div>
                 <div class="form-group">
                    <label for="kebutuhuan">Kebutuhan</label>
                    <input type="text" name="kebutuhan" id="kebutuhan" class="form-control" autofocus autocomplete="off" required>
                </div>
                <div class="form-group">
