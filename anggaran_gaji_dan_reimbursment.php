...
<head>
    ...
    <title>Anggaran Gaji dan Reimbursment</title>
...
<div id="main">
    ...
    <div class="card-body" style="margin-left: 200px; margin-right: 200px; margin-top:50px;">
            <form action="function_anggaran.php" method="POST" >
                <h2 align="center">ANGGARAN GAJI DAN REIMBURSMENT</h2><hr>
                <div class="form-group">
                    <label for="sender_name">Sender Name</label>
                    <input type="text" name="sender_name" id="sender_name" class="form-control" autofocus autocomplete="off" required>
                </div>
                <div class="form-group">
                ...
                <input type="text" class="form-control" name="intended_for" id="intended_for">
                  <!-- <option> </option>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date" id="date" class="form-control" autofocus autocomplete="off" required>
                </div>
